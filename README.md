...
> View this app [here..](https://github.com/Rohanchaudhary94/movies-app)
...
> Run this app by directly opening the [Link here](https://github.com/Rohanchaudhary94/movies-app) or follow steps mentioned below to set up on local directory.
